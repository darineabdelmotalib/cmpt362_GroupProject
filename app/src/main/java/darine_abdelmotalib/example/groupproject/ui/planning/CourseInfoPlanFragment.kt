...
import darine_abdelmotalib.example.groupproject.databinding.FragmentCourseInfoPlanBinding

class CourseInfoPlanFragment : Fragment() {
    private var _binding: FragmentCourseInfoPlanBinding? = null
